...
def main(args):
    ...
    print(type(observe_train))
    print(type(observe_test))
    print(type(v_train))
    print(type(v_test))
    print("Observe train = ", observe_train.shape)
    print("Observe test = ", observe_test.shape)
    print("V train = ", v_train.shape)
    print("V test = ", v_test.shape)
    ...
    print(type(observe_v))
    #print("Observe v = ", observe_v.shape)

    input_data = [bc, ic, observe_v]
    print("input data =",len( input_data[2]))
    ...
    np.savetxt("v_pred_model.txt",np.hstack((observe_x,v_pred_model)),header="observe_x, v_pred_model")
    ...
    if args.plot and args.dim == 1:
        ...
        plot_3D(data_list,dynamics, model, args.model_folder_name)
    return model
