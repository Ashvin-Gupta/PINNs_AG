...
% reparameterisation using parameters in Lillienkamp et al, Chaos, 2022
...
tend = tstar+305;
tCF=55; % time (AU) at which the extra stimulus is applied
tCF2=100;
tCF3=150;
...
%     fibloc=[floor(X/3) ceil(X/3+X/5)]; % location of (square) heterogeneity
    ...
    D0 = 0.005; % mm^2/UA, diffusion coefficient (for monodomain equation)
